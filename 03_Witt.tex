...
\end{lemma}
\begin{proof}
$G=\Aut(V,\omega)$ for some vector space $V$ with  bilinear form $\omega$. Let $\{e_1,\dots,e_n\}$ be a basis of $V$\FlorianSagt{maybe choose the basis in a clever way} and $H=\Aut(\langle e_1,\dots,e_{n-1}\rangle,\omega)$. Our aim is to find for any $g\in G$ an $g'\in H$ such that $d(g,g')\leq\frac{4}{n}$.
