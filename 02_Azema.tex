...
One often thinks of $\Sigma'$ as the available information, a finer partition means more information. Then $\E(f\mid \Sigma')$ is the best approximation of $f$ given only the information from $\Sigma'$. 
