...
\begin{lemma}
Let $(X,d,\mu)$ be a finite mm-space with diameter $d$ and %\FlorianSagt{could be that this only holds for finite $X$ as conditions in definition of length are just almost surely}
...
\begin{lemma}
Let $(X,d,\mu)$ be a finite mm-space with diameter 1 and $\Delta=\min_{x\not=x} d(x,y)$. Then the length of $X$ is at least $\Delta^{\frac{1}{2}}$.
\end{lemma}
