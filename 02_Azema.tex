...
\begin{proof}
\begin{align*}
\mu(\{f-\mathbb{E}(f)\geq c\})&=\mu(\{\sum_{i=1}^{n}d_i\geq  c\})\\
&=\mu(\{\lambda\cdot\sum_{i=1}^{n}d_i\geq \lambda c\})\\
&=\mu(\{e^{\lambda\cdot\sum_{i=1}^{n}d_i-\lambda c}\geq 1\})\\
&\leq\E(e^{\lambda\cdot\sum_{i=1}^{n}d_i})\cdot e^{-\lambda c}\\
&=\E(e^{\lambda d_1}\cdot\ldots\cdot e^{\lambda d_{n-1}}\cdot\E(e^{\lambda\cdot d_n}\mid \Sigma_{n-1}))\cdot e^{-\lambda c}\\
&\leq\E(e^{\lambda d_1}\cdot\ldots\cdot e^{\lambda d_{n-1}})\cdot e^{\lambda\cdot \|d_n\|^2_\infty}\cdot e^{-\lambda c}\\
&\hspace{3cm}\vdots\\
&\leq e^{\lambda\cdot \|d_1\|^2_\infty}\cdot\ldots\cdot e^{\lambda\cdot \|d_{n-1}\|^2_\infty}\cdot e^{\lambda\cdot \|d_n\|^2_\infty}\cdot e^{-\lambda c}\\
&=e^{\lambda\cdot\sum_{i=1}^n\|d_i\|^2_\infty-\lambda c}
\end{align*}
\end{proof}
